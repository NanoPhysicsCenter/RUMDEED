...
DOUBLE PRECISION, INTENT(IN)         :: u ! Changed from IN OUT to IN by KT
...
DOUBLE PRECISION, INTENT(IN)         :: x ! Changed from IN OUT to IN by KT
DOUBLE PRECISION, INTENT(IN)         :: y ! Changed from IN OUT to IN by KT
...
INTEGER, INTENT(IN)                      :: ifac ! Changed from IN OUT to IN by KT
DOUBLE PRECISION, INTENT(IN)             :: x
...
INTEGER, INTENT(IN)                      :: ic ! Changed from IN OUT to IN by KT
...
! LF0  = FLAG.  SET IT TO 0 FOR LOGGAMMA, AND 1 FOR GAMMA
      DOUBLE PRECISION CANS(2),COEF(7),F0,F1,G0,G1,&
