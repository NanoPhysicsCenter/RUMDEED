...
\subsubsection{Nondimensionalization}
  ...
  Fyrst electron: \(x_1 = 10\,\mathrm{nm}\), \(y_1 = 3\,\mathrm{nm}\), \(z_1 = 100\,\mathrm{nm}\).\\
  Second electron: \(x_2 = 35\,\mathrm{nm}\), \(y_2 = -7\,\mathrm{nm}\), \(z_2 = 10\,\mathrm{nm}\).\\
  The hole: \(x_3 = -12\,\mathrm{nm}\), \(y_3 = 0\,\mathrm{nm}\), \(z_3 = 50\,\mathrm{nm}\).\\
  Parameters: \(d 100\,\mathrm{nm}\), \(V = 2\,\mathrm{V}\), \(\Delta t = 0.25\,\mathrm{ps}\).

  The acceleration of the fyrst electron is
  \begin{equation}
    \mathbf{a}_{12} = \frac{e^2}{4\pi\epsilon_0} \frac{\mathbf{R}_1 - \mathbf{R}_2}{|\mathbf{R}_1 - \mathbf{R}_2|^3}
  \end{equation}
  \begin{equation}
    \mathbf{a}_{13} = \frac{e^2}{4\pi\epsilon_0} \frac{\mathbf{R}_1 - \mathbf{R}_3}{|\mathbf{R}_1 - \mathbf{R}_3|^3}
  \end{equation}
