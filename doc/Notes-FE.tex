...
\section{Fowler-Nordheim equation}
\begin{equation}
...
\section{Surface Field Calculations}
...
%
%
\section{Electric field for hyperbolid tip}
  ...
  \end{equation}
%
\section{Area calculations for hyperbolid tip}
...
\section{Radius of Curvature}
  ...
  \end{equation}
%
\section{Normal Vector to surface}
  Starting with
  \begin{equation}
    \xi = \frac{1}{2a}\left( \sqrt{x^2 + y^2 + (z+a)^2} + \sqrt{x^2 + y^2 + (z-a)^2} \right)
  \end{equation}
