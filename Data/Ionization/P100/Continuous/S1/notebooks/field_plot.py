...
print(f'RMS: {rms:.3f} MV/m')
print(f'Relative RMS: {rms/abs(ic_field.mean())*100:.3f} %')

fig = plt.figure(figsize=(16,8))
ax1 = fig.add_subplot(111, projection='3d', facecolor='white')  # Set facecolor to white to remove grey background
ax1.view_init(elev=20, azim=-50)  # Adjust elevation and azimuth for rotation
...
ax1.set_xlabel('x [nm]',size='large')
ax1.set_ylabel('y [nm]',size='large')
ax1.set_zlabel('Field [MV/m]',size='large')
...
ax2.set_xlabel('x [nm]',size='large')
ax2.set_ylabel('y [nm]',size='large')
ax2.set_zlabel('Field [MV/m]',size='large')
